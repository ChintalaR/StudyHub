...
//require_once($_SERVER["DOCUMENT_ROOT"].'/jetcargogroup/Admin/const.php');
/**
 * PDO SINGLETON CLASS
 *
 * @author Tony Landis
...
class Db
{
     ...
     * @return PDO
     */
    public function __construct($host = DB_HOST, $dbname = DB_NAME, $username = DB_USER, $password = DB_PASS, $driver_options = array(PDO::ATTR_PERSISTENT => true))
    {
        if (!self::$PDOInstance) {
            try {
